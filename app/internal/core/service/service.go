...
import (
	...
	repository_port "fernandoglatz/can-bus-bridge/internal/core/port/repository"
	"fernandoglatz/can-bus-bridge/internal/infrastructure/repository"
)
...
func (service Service[T]) Get(ctx context.Context, id int) (T, *exceptions.WrappedError) {
